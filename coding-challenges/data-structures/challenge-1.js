...
// Note -> the correct syntax is of the form alias : property
...
function printGoals(...names) {
  ...
  names.forEach(name => (printString += `${name} scored a goal! `));
  printString += ` There were a total of ${names.length} goals.`;
